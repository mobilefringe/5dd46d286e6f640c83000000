                        ...
                        <div class="col-md-8">
                            ...
                            <div v-if="deliveryAvailable" class="margin_30">
                                ...
                                <div class="store_details_delivery">
                                    ...
                                    <img v-if="hasToast" class="delivery_option" src="//codecloud.cdn.speedyrails.net/sites/5dd46d286e6f640c83000000/image/png/1586796105957/toast_takeout.png" alt="Delivery available with Toast TakeOut" />
                ...
                updateCurrentStore(id) {
                    ...
                    if (this.currentStore === null || this.currentStore === undefined) {
                        ...
                        if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                            ...
                            if (_.includes(subcategories, 8327)) {
                                this.hasUberEats = true;
                            }
                            if (_.includes(subcategories, 8324)) {
                                this.hasDoordash = true;
                            }
                            if (_.includes(subcategories, 8325)) {
                                this.hasGrubhub = true;
                            }
                            if (_.includes(subcategories, 8326)) {
                                this.hasPostmates = true;   
                            }
                            if (_.includes(subcategories, 8328)) {
                                this.hasRestaurantDelivery = true;   
                            }
                            if (_.includes(subcategories, 9374)) {
                                this.hasDrizly = true;   
                            }
                            if (_.includes(subcategories, 9375)) {
                                this.hasToast = true;   
                            }
                        }
